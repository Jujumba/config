...
maps.n["<leader>v"] = { "<cmd>vsplit<cr>", desc = "Split the current buffer vertically" }
  maps.n["<leader>h"] = { "<cmd>split<cr>", desc = "Split the current buffer horizontally" }
maps.n["]b"] =
...
-- vim.api.nvim_set_keymap('n', '<C-j>', '<cmd>MultipleCursorsAddDown<CR>', { noremap = true })
-- vim.api.nvim_set_keymap('n', '<C-k>', '<cmd>MultipleCursorsAddUp<CR>', { noremap = true })
--
-- maps.n["<C-j>"] = { "<cmd>MultipleCursorsAddDown<CR>", mode = {"n", "i"}}
-- maps.n["<C-k>"] = { "<cmd>MultipleCursorsAddUp<CR>", mode = {"n", "i"}}
-- vim.api.nvim_set_keymap('n', '<C-d>', '<Nop>', {noremap = true})
--
-- vim.api.nvim_set_keymap('n', '<C-Up>', '<Nop>', { noremap = true })
-- vim.api.nvim_set_keymap('n', '<C-Down>', '<Nop>', { noremap = true })
